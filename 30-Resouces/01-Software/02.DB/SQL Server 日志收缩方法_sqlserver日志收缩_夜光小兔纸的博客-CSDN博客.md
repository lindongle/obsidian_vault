...
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»在日常运维中，有时会遇到«/span»“The transaction log for database ‘xxxx’ is full due to ‘ACTIVE_TRANSACTION’.”«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»这样的报错信息。«/span»  
 «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»此错误消息表明：数据库的事务日志文件空间耗尽，«/span»log «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»文件不能再存储新的«/span»transaction log«span style='font-family:"Microsoft YaHei"; font-size:12.0pt'»。«/span»  
 «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»这个时候我们需要进行日志收缩。本文将介绍日志收缩的两种方法。«/span»
**通过图形界面进行日志收缩**
第一步：右键数据库属性
![image1](440f8ebcefac4a62beba3e5c946f895e.png)
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»第二步：更改数据库恢复模式，将模式改为«/span»Simple«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»。«/span»  
 
![image2](2f1313c02fb04a4e804d7db21992f85a.png)
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»第三步：右键数据库，«/span»Tasks→Shrink→Files «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»。«/span»  
 
![image3](be5d2ce1fed34de8a567a1d7e3da0131.png)
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»第四步：收缩数据库日志，选择文件类型«/span»Log«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»，并在«/span»Shrink action «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»中将文件收缩到给出的«/span»Minimum «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»值，这里的数据库因为是新建的没有数据，所以提供的«/span»Minimum «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»值为«/span»0MB«span style='font-family:"Microsoft YaHei"; font-size:12.0pt'»，可以将红框«/span»3«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»中的数字修改为«/span»0«span style='font-family: "Microsoft YaHei";font-size:12.0pt'»。«/span»  
...
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»分离数据库操作如下：«/span»  
 «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»右击数据库，«/span»Task→Detach  
...
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»附加数据库操作如下：«/span»  
 «span style='font-family: "Microsoft YaHei";font-size:12.0pt'»右击«/span»Databases«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»，单击«/span»Attach  
 
![image8](6c1ada23750f4040828eb3d79b0df3bf.png)
«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»点击«/span»Add«span style='font-family:"Microsoft YaHei";font-size:12.0pt'»，添加数据库文件«/span»  
