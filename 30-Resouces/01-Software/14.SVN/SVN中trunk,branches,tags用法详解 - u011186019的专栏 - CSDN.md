---
title: SVN中trunk,branches,tags用法详解 - u011186019的专栏 - CSDN...
updated: 2026-06-06T00:25
created: 2019-07-27T00:09:38
---

SVN中trunk,branches,tags用法详解 - u011186019的专栏 - CSDN博客
星期五, 七月 26, 2019
4:09 下午
已剪辑自: <https://blog.csdn.net/u011186019/article/details/52045202>
...
文档、制作安装程序、打包等）结束后，代码处于冻结状态（人为规定，可以通过hook来进行管理）。此  

  
时应该基于当前冻结的代码库，打tag。当下一个版本/阶段的开发任务开始，继续在trunk进行开发。  
此时，如果发现了上一个已发行版本（Released Version）有一些bug，或者一些很急迫的功能要求，而  

  
正在开发的版本（Developing Version）无法满足时间要求，这时候就需要在上一个版本上进行修改了。  
...
+tags/  
+tag_release_1.0 (copy from trunk)  
1.0有bug，直接在dev1.0的分支上修复Subversion有一个很标准的目录结构，是这样的。  
比如项目是proj，svn地址为svn://proj/，那么标准的svn布局是  
