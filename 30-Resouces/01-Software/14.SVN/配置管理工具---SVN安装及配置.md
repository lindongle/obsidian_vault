...
# <span style='color:#1E4E79'>软件开发的过程是个复杂、耗时、耗力的过程。通常要有很多开发人员参与编写代码。</span>
## <span style='color:#2E75B5'>这样就会出现种种代码管理混乱的问题，这些问题容易引发BUG，增加开发人员的工作量，增加软件开发与维护的成本。因此项目中会使用配置工具管理这些代码，解决上诉问题。</span>
### <span style='color:#5B9BD5'>市面上常用的两种配置管理工具：SVN，GIT</span>
### <span style='color:#5B9BD5'>这边文章要和大家介绍的就是SVN</span>
