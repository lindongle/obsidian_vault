...
<table style="border-collapse: collapse"><tbody><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">插件名称</h3></td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">功能说明</h3></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">适用场景</h3></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Daily Notes</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">每日笔记，快速创建当天的日记文件</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">日常记录、工作日志</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Calendar</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">日历视图，直观查看和创建日记</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">配合</font> Daily Notes</td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Templater</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">高级模板引擎，支持动态变量和脚本</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">日记模板、项目模板</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Dataview</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">像数据库一样查询笔记</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">动态汇总、任务管理</font></td></tr></tbody></table>

## **5.2 效率插件**

<table style="border-collapse: collapse"><tbody><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">插件名称</h3></td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">功能说明</h3></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">适用场景</h3></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">QuickAdd</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">快速添加内容，一键创建多种类型笔记</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">快速记录、模板调用</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Todoist</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">任务管理，同步</font> Todoist 任务到笔记</td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">任务管理</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Command Palette+</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">增强命令面板功能</font></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">快速操作</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Linter</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">自动格式化</font> Markdown 笔记</td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">保持笔记整洁</font></td></tr></tbody></table>

## **5.3 同步与备份**

<table style="border-collapse: collapse"><tbody><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">插件名称</h3></td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">功能说明</h3></td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">适用场景</h3></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Remotely Save</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">支持</font> S3/WebDAV/一类云同步</td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">多设备同步</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Git</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">使用</font> Git 管理版本和同步</td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">版本控制、备份</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Self-hosted LiveSync</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">基于</font> CouchDB 的实时同步</td><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">实时多端同步</font></td></tr></tbody></table>

## **5.4 可视化与思维工具**

<table style="border-collapse: collapse"><tbody><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">插件名称</h3></td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">功能说明</h3></td><td colspan="2" data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><h3 style="text-align:center">适用场景</h3></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Excalidraw</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">在</font> Obsidian 中直接绘制白板和图表</td><td colspan="2" data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">思维导图、流程图</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Mind Map</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">将当前笔记生成思维导图</font></td><td colspan="2" data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">快速梳理思路</font></td></tr><tr><td data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px">Banner</td><td data-colwidth="268" width="268" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">为笔记添加顶部图片</font></td><td colspan="2" data-colwidth="166" width="166" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><font face="微软雅黑">美化笔记</font></td></tr><tr><td colspan="3" data-colwidth="166,268,0" width="601" valign="top" style="border: 1px solid #ddd; padding: 6px 10px"><b><font face="微软雅黑">��</font><font face="微软雅黑">小贴士：</font></b><font face="微软雅黑">插件不是越多越好！建议初学者先安装</font> Daily Notes + Templater + Dataview 三个核心插件，熟练后再扩展。</td><td style="border: 1px solid #ddd; padding: 6px 10px"><br></td></tr></tbody></table>
