...
1.  及时回复：
Dear Customer,
Thanks for contacting TCNX Support. We are now investigating it and will reply you once we have any progress on it.
2.  跟踪状态：
    1.  tickets上：
Hi.I think the problem has been solved,If there is no problem, please reply on the page, do not reply by email, thank you.
2.  邮件催促：ticket上找到其邮件进行回复，注意自己邮箱账号改为英文的
Hello scholer，
We would like to confirm the current status of ticket 4357.
