...
- Solution
- Need to configure the PDF Data for markup ability in addition to viewing.  

  Below are Teamcenter preferences that need to be configured to allow PDF dataset viewing and markup using TcVis in the embedded viewer.  
